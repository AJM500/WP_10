...
blocks.push(new Block(50, 50, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
blocks.push(new Block(50, 450, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
blocks.push(new Block(50, 250, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
...
blocks.push(new Block(900, 50, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
blocks.push(new Block(900, 450, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
blocks.push(new Block(900, 250, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
...
for (let y = 150; y <= 350; y += 25) {
    blocks.push(new Block(250, y, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
}
