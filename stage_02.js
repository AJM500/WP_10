...
for (let x = 380; x <= 620; x += 40)
    blocks.push(new Block(x, 140, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
...
for (let x =220 ; x <= 380; x += 40)
    blocks.push(new Block(x, 180, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
...
for (let x =220 ; x <= 380; x += 40)
    blocks.push(new Block(x, 420, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
...
for (let y = 260; y <= 340; y += 40)
    blocks.push(new Block(220, y, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));


for (let y = 260; y <= 340; y += 40)
    blocks.push(new Block(780, y, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));


blocks.push(new Block(330, 280, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));
blocks.push(new Block(660, 280, Math.floor(Math.random()*3)+1, Math.floor(Math.random()*3), "grass", blockImgs));